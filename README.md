...
```js
import React, { Component } from 'react';
import './Button.css'; Card.js

class ButtonCard.jsComponent {
  render() {
...
in all web browsers. Service worker registration [won't be attempted](src/components/utilities/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](src/components/utilities/registerServiceWorker.js), which
